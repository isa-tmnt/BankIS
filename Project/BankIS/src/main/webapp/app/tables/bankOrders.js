...
app.component('bankOrders', {
    ...
    controller: ['$scope', '$http', '$attrs', '$rootScope', '$compile', '$element', '$routeParams', function OrdersCtrl($scope, $http, $attrs, $rootScope, $compile, $element, $routeParams) {
        ...
        $scope.nexts = [
            { label: "Transfer Items", link: "/#!/transferItems", filterProperty: "bankOrder" },
            { label: "Closing Accounts", link: "/#!/closingAccounts", filterProperty: "bankOrder" },
        ];
